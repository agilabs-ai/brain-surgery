var EdgeCloud=(()=>{var v=Object.defineProperty;var O=Object.getOwnPropertyDescriptor;var D=Object.getOwnPropertyNames;var I=Object.prototype.hasOwnProperty;var W=(t,e,i)=>e in t?v(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var C=(t,e)=>{for(var i in e)v(t,i,{get:e[i],enumerable:!0})},L=(t,e,i,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of D(e))!I.call(t,s)&&s!==i&&v(t,s,{get:()=>e[s],enumerable:!(r=O(e,s))||r.enumerable});return t};var H=t=>L(v({},"__esModule",{value:!0}),t);var o=(t,e,i)=>W(t,typeof e!="symbol"?e+"":e,i);var K={};C(K,{mount:()=>Z});var w=`#version 300 es
...
}`;function N(){let t=navigator.userAgent.toLowerCase();return t.includes("safari")&&!t.includes("chrome")&&!t.includes("android")}function j(t){let e=visualViewport?.scale??1,i=visualViewport?.width??window.innerWidth,r=window.innerWidth-t.documentElement.clientWidth,s=e*i+r,a=outerWidth/s,n=Math.round(100*a);return n%5===0?n/100:n===33?1/3:n===67?2/3:n===133?4/3:a}var U={fit:"none",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},z={none:0,contain:1,cover:2};var P=`
...
`,y={simplex:1,warp:2,dots:3,wave:4,ripple:5,swirl:6,sphere:7},V={random:1,"2x2":2,"4x4":3,"8x8":4};function S(t){if(Array.isArray(t))return t.length===4?t:t.length===3?[...t,1]:d;if(typeof t!="string")return d;let e,i,r,s=1;if(t.startsWith("#"))[e,i,r,s]=Y(t);else if(t.startsWith("rgb")){let a=k(t);if(a===null)return d;[e,i,r,s]=a}else if(t.startsWith("hsl")){let a=$(t);if(a===null)return d;[e,i,r,s]=q(a)}else return console.error("Unsupported color format",t),d;return[_(e,0,1),_(i,0,1),_(r,0,1),_(s,0,1)]}function Y(t){if(t=t.replace(/^#/,""),(t.length===3||t.length===4)&&(t=t.split("").map(a=>a+a).join("")),t.length===6&&(t=t+"ff"),!/^[0-9a-f]{8}$/i.test(t))return console.warn("Invalid hex color"),d;let e=parseInt(t.slice(0,2),16)/255,i=parseInt(t.slice(2,4),16)/255,r=parseInt(t.slice(4,6),16)/255,s=parseInt(t.slice(6,8),16)/255;return[e,i,r,s]}function k(t){let e=t.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i);return e?[parseInt(e[1]??"0")/255,parseInt(e[2]??"0")/255,parseInt(e[3]??"0")/255,e[4]===void 0?1:parseFloat(e[4])]:null}function $(t){let e=t.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i);return e?[parseInt(e[1]??"0"),parseInt(e[2]??"0"),parseInt(e[3]??"0"),e[4]===void 0?1:parseFloat(e[4])]:null}function q(t){let[e,i,r,s]=t,a=e/360,n=i/100,l=r/100,c,p,h;if(i===0)c=p=h=l;else{let f=(x,R,u)=>(u<0&&(u+=1),u>1&&(u-=1),u<.16666666666666666?x+(R-x)*6*u:u<.5?R:u<.6666666666666666?x+(R-x)*(.6666666666666666-u)*6:x),m=l<.5?l*(1+n):l+n-l*n,b=2*l-m;c=f(b,m,a+1/3),p=f(b,m,a),h=f(b,m,a-1/3)}return[c,p,h,s]}var _=(t,e,i)=>Math.min(Math.max(t,e),i),d=[.5,.5,.5,1];function Z(t,e){e=e||{};let i=Object.assign({},U,{colorBack:"#ffffff",colorFront:"#154CFF",shape:"simplex",type:"4x4",size:2,scale:.6,speed:.35,frame:0,rotation:0,offsetX:0,offsetY:0},e),r={u_colorBack:S(i.colorBack),u_colorFront:S(i.colorFront),u_shape:y[i.shape],u_type:V[i.type],u_pxSize:i.size,u_fit:z[i.fit],u_scale:i.scale,u_rotation:i.rotation,u_offsetX:i.offsetX,u_offsetY:i.offsetY,u_originX:i.originX,u_originY:i.originY,u_worldWidth:i.worldWidth,u_worldHeight:i.worldHeight};return new g(t,B,r,void 0,i.speed,i.frame)}return H(K);})();
